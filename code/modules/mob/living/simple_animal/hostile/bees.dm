...
/mob/living/simple_animal/hostile/poison/bees
	name = "bee"
	desc = "hey buddy i think you got the wrong hive, the buzz club's two blocks down<br>fuck you<br>ah, fuck you bee-head. maybe you and i should settle it right here on the hive floor"
	icon_state = ""
	icon_living = ""
